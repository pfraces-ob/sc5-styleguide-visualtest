...
var phantomProcess;
var runPhantom = function runPhantom() {
...
var getGemini = function getGemini(options) {
...
var getTestPaths = function getTestPaths(options, allTests) {
  if (!allTests) {
  ...
  if (options.sections) {
    ...
    allTests.forEach(function (section) {
      options.sections.forEach(function (sectionToInclude) {
  ...
  var testPaths = tests.map(function (sec) {
...
module.exports.test = function (options) {
  ...
  var test = function test(file, enc, callback) {
    ...
    var runTests = function runTests() {
      ...
      runTestsPromise.done(function (result) {
...
module.exports.gather = function (options) {
  ...
  var gather = function gather(file, enc, callback) {
    var _this = this;

    // Provide configuration
    var getPages = function getPages(path) {
    ...
    ['./_core-test.js', './_build-page-obj.js'].forEach(function (fileName) {
    ...
    var runGather = function runGather() {
